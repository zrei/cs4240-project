...
public static class Logger
{
    ...
    public static void Log(System.Type singletonType, string message, LogLevel level)
    {
        Log(singletonType.Name, message, level);
    }
    ...
    public static void Log(System.Type classType, Object context, string message, LogLevel level)
    {
        Log(classType.Name, context.name, message, context, level);
    }
    ...
    public static void LogEditor(System.Type classType, string message, LogLevel level)
    {
        LogEditor(classType.Name, message, level);
    }
